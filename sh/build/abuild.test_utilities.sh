...
cl.exe ${msvcCompilerFlags} /internalPartition /ifcSearchDir \"${buildDir}\" /ifcSearchDir \"${buildRoot}/abuild/cpptokenizer\" ^ /ifcOutput\"${buildDir}/abuild.test_utilities-test_project.ifc\" /Fo\"${buildDir}/abuild.test_utilities-test_project.obj\" /c /TP \"${projectDir}/test_project.cpp\" || exit 1
...
lib.exe /NOLOGO ^
        ...
        \"${buildDir}/abuild.test_utilities-test_project.obj\" ^
