...
lib.exe /NOLOGO abuild.obj build_cache.obj settings.obj toolchains.obj toolchain_scanner_windows.obj project_scanner.obj projects.obj tokenizer.obj dependency_scanner.obj dependencies.obj /OUT:abuild.lib
