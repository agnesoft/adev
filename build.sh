...
"$CLANG" $CPP_AND_LINK_FLAGS "$PROJECTS_ROOT/abuild/test/main.cpp" "$PROJECTS_ROOT/abuild/test/header_test.cpp" "$PROJECTS_ROOT/abuild/test/source_test.cpp" "$PROJECTS_ROOT/abuild/test/project_scanner_headers_test.cpp" "$PROJECTS_ROOT/abuild/test/project_scanner_sources_test.cpp" "$PROJECTS_ROOT/abuild/test/project_scanner_projects_test.cpp" "$PROJECTS_ROOT/abuild/test/settings_test.cpp" "$PROJECTS_ROOT/abuild/test/project_test.cpp" "$PROJECTS_ROOT/abuild/test/build_cache_test.cpp" "$BUILD_ROOT/acore/acore.obj" "$BUILD_ROOT/abuild/abuild.obj" "$BUILD_ROOT/atest/atest.obj" "$BUILD_ROOT/abuild_test/abuild_test_utilities.obj" -o "$BUILD_ROOT/bin/abuild_test"
cd ..
