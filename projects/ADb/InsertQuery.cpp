...
auto InsertQuery::createInsertNodeQuery(std::string name, BindPlaceholderFunction bind) -> Query
{
...
auto InsertQuery::createInsertNodeQuery(Query &&subQuery, BindResultFunction bind) -> Query
{
    Query query{InsertNodeData{}};
