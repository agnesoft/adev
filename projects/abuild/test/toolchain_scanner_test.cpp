...
static const auto testSuite = suite("abuild::ToolchainScanner", [] {
    test("msvc2019_x64_Community", [] {
        ...
        TestProjectWithContent testProject{"abuild_toolchain_scanner_test",
                                           {{".abuild", "{ \"settings\": { \"clangInstallDirectory\": \"\", \"msvcInstallDirectory\": \"" + msvcInstallDirectory.generic_string() + "\" } }"},
    ...
    test("clang", [] {
        ...
        TestProjectWithContent testProject{"abuild_toolchain_scanner_test",
                                           {{".abuild", "{ \"settings\": { \"clangInstallDirectory\": \"" + clangInstallDirectory.generic_string() + "\", \"msvcInstallDirectory\": \"\" } }"},
#ifdef _WIN32
                                            {"LLVM/bin/clang++.exe", ""},
                                            {"LLVM/bin/lld.exe", ""},
