...
{
    REQUIRE_FALSE(std::is_default_constructible_v<agraph::DepthFirstSearch<agraph::Graph, SearchHandler>>);
    REQUIRE(std::is_copy_constructible_v<agraph::DepthFirstSearch<agraph::Graph, SearchHandler>>);
    REQUIRE(std::is_nothrow_move_constructible_v<agraph::DepthFirstSearch<agraph::Graph, SearchHandler>>);
    REQUIRE(std::is_copy_assignable_v<agraph::DepthFirstSearch<agraph::Graph, SearchHandler>>);
    REQUIRE(std::is_move_assignable_v<agraph::DepthFirstSearch<agraph::Graph, SearchHandler>>);
}
