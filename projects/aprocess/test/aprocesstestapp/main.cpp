...
auto main(int argc, char *argv[]) -> int
{
    ...
    try
    {
        ...
        parser.option().long_name("echo-input-timeout").default_value(std::int64_t{1000}).description("Print the values received on stanard input for <value> milliseconds").bind_to(&inputs.echoInputTimeout);
